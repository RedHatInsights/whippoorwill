...
[id="{anchor_prefix}-cloud-redhat-com-clowder-v2-apis-cloud-redhat-com-v1alpha1-apigatewayconfig"]
==== ApiGatewayConfig 
...
| *`apiGateway`* __xref:{anchor_prefix}-cloud-redhat-com-clowder-v2-apis-cloud-redhat-com-v1alpha1-apigatewayconfig[$$ApiGatewayConfig$$]__ | Defines the configuration for the API gateway
|===
...
| *`apiEndpoint`* __string__ | ApiEndpoint is the string that will be used in the api gateway as the services endpoint.
|===
